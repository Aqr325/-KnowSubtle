...
hiddenimports = ['local_metagpt.stub', 'learning_agent_system.orchestrator', 'learning_agent_system.schema', 'sqlalchemy', 'sqlalchemy.dialects.sqlite.aiosqlite', 'aiosqlite', 'webview', 'bottle']
